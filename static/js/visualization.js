function stacked_bar(data) {
    ...
    var svg = d3.selectAll(".stacked-bar").append("svg")
    ...
    data.forEach(function (d) {
        var mystate = d.Month; //add to stock code
        var y0 = 0;
    ...
    function plotSingle(d) {
        ...
        for (i = 0; i < legendClassArray.length; i++) {
            if (legendClassArray[i] != class_keep) {
                console.log(d3.selectAll(".class" + legendClassArray[i]))
                console.log(".class" + legendClassArray[i])
                d3.selectAll(".class" + legendClassArray[i])
                    .transition()
                    .duration(1000)
                    .style("opacity", 0);
